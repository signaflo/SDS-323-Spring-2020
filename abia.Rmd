...
# try with proportion
ggplot(abia, aes(x = Month, y = (Cancelled==1)/(sum(Cancelled)), fill = Dest)) + geom_bar(stat = "identity")

# redo
ggplot(cancelled, aes(x = Month, y = Cancelled, fill = Dest)) + geom_bar(position = "fill", stat = "identity") +
