...
# We defined a new dummy variable Viral. Viral is 1 when the shares are greater than 1400. 
...
# This chart shows the relationship between the value of K and classification error. This chart helps us to find k = 28 has the smallest classification error 38%.    
...
ACC = (2280 + 2162) / sum(confusion_out)


# Overall error rate is 44%
1 - (2280 + 2162) / sum(confusion_out)
