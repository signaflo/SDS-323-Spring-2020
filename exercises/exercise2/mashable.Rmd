...
k_grid <- exp(seq(log(1), log(400), length=40)) %>% round %>% unique
...
Thus, K =  satisfies the criteria better than K = `r best_k`, so we find the optimal K based on a higher accuracy rate out-of-sample.
```{r  }
