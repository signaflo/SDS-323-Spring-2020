...
between variables can be made clear and explicit. Using linear regression gives us a 
...
Specifically, the Saratgo County tax authority should predict prices using a linear
