...
## Conclusion
It seems that the 65 trim has a much wider range, so the best KNN model follows that variation. In contrast, the 350 trim, although its mean is being pulled downwards from low values, is more normally distributed and thus the optimal K can "smooth" over more points.
